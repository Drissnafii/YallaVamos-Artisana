                        ...
                        <div class="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition-all cursor-pointer relative group flex"
                            ...
                            <div class="p-4 flex-grow">
                                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="font-bold text-base">{{ $match->team1 }} vs {{ $match->team2 }}</div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex justify-between items-center text-xs text-gray-500 mt-2">
                                    ...
                                    <div class="flex items-center {{ in_array($match->id, $favoriteMatchIds ?? []) ? 'text-amber-500' : 'text-gray-400 group-hover:text-amber-400' }} transition-colors">
