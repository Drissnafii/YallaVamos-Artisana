...
<div class="admin-dashboard-content">
  <div class="bg-white shadow rounded-lg overflow-hidden flex flex-col h-full">
    ...
    <div class="px-6 py-5 border-b border-gray-200 flex justify-between items-center">
        ...
        <a href="{{ route('admin.users.create') }}" class="inline-flex items-center px-4 py-2 bg-primary text-white text-sm font-medium rounded-md shadow-sm hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors duration-200">
    ...
    <div class="p-4 bg-gray-50 border-b border-gray-200">
        <div class="max-w-4xl mx-auto">
            <div class="relative flex rounded-full shadow-sm border border-gray-300 bg-white hover:shadow-md focus-within:shadow-md transition-shadow duration-200">
                ...
                <input
                    type="text"
                    id="search-users"
                    class="py-3 pl-10 pr-4 block w-full rounded-full border-none focus:ring-2 focus:ring-primary focus:border-transparent sm:text-sm"
    ...
    <div class="admin-table-scroll-area">
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex justify-end items-center space-x-2">
                            <a href="{{ route('admin.users.edit', $user) }}" class="text-primary hover:text-primary-dark transition-colors duration-150">
