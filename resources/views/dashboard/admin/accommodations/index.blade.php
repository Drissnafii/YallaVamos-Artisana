...
<div class="container mx-auto max-w-6xl px-4 py-5">
    ...
    <div class="mb-5 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        ...
        <a href="{{ route('admin.accommodations.create') }}" class="ml-auto flex items-center px-4 py-2 bg-white text-gray-600 border border-gray-300 rounded-full hover:shadow-md transition-all text-sm font-medium">
    ...
    <div class="bg-white shadow-sm rounded-lg overflow-hidden border border-amber-100 mb-5">
        <div class="bg-amber-50 px-5 py-3 border-b border-amber-100 flex items-center">
            ...
            <h3 class="text-base font-medium text-gray-800">Search & Filters</h3>
        </div>
        ...
        <div class="p-5 space-y-5">
            ...
            <div class="mb-3">
                <form action="{{ route('admin.accommodations.index') }}" method="GET" class="flex flex-col md:flex-row gap-2">
                    <div class="flex-1 relative rounded-full shadow-sm">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                            </svg>
                        </div>
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search by name, address, or city..." class="focus:ring-amber-500 focus:border-amber-500 block w-full pl-10 pr-12 py-2 border border-gray-300 rounded-full">
                    </div>
                    <button type="submit" class="inline-flex items-center justify-center px-4 py-2 bg-amber-50 text-amber-600 rounded-full hover:bg-amber-100 transition-colors duration-200 border border-amber-200 font-medium text-sm">
            ...
            <div class="border-t border-gray-200 pt-4">
                ...
                <div id="filterOptions" class="hidden">
                    <form action="{{ route('admin.accommodations.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div class="md:col-span-3 flex justify-end space-x-3">
                            <a href="{{ route('admin.accommodations.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-full text-gray-700 bg-white hover:bg-gray-50 hover:shadow-sm transition-all">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                                </svg>
                                Reset
                            </a>
                            <button type="submit" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full shadow-sm text-white bg-amber-600 hover:bg-amber-700 hover:shadow-md transition-all">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
                                </svg>
                                Apply Filters
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
        ...
        <div class="bg-white shadow-sm rounded-lg overflow-hidden border border-amber-100">
    ...
    <div class="bg-white shadow-sm rounded-lg overflow-hidden border border-amber-100">
        <div class="bg-amber-50 px-5 py-3 border-b border-amber-100 flex justify-between items-center">
            <div class="flex items-center">
                ...
                <h3 class="text-base font-medium text-gray-800">All Accommodations</h3>
            </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-amber-50 transition-colors duration-150">
                        <td class="px-5 py-3">
                            <div class="flex items-center">
                                @if($accommodation->image)
                                    <img src="{{ asset('storage/' . $accommodation->image) }}" alt="{{ $accommodation->name }}" class="h-12 w-16 rounded object-cover mr-3 border border-gray-200">
                                @else
                                    <div class="h-12 w-16 rounded bg-amber-100 flex items-center justify-center mr-3 border border-amber-200">
                        ...
                        <td class="px-5 py-3">
                            <span class="px-3 py-1 inline-flex text-xs leading-5 font-medium rounded-full bg-amber-100 text-amber-800">
                        ...
                        <td class="px-5 py-3 text-right text-sm font-medium">
                            <div class="flex justify-end space-x-1">
                                <a href="{{ route('admin.accommodations.show', $accommodation) }}" class="text-gray-600 hover:text-gray-900 bg-gray-100 hover:bg-gray-200 p-2 rounded-full transition-colors duration-150" title="View Details">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                    </svg>
                                </a>
                                <a href="{{ route('admin.accommodations.edit', $accommodation) }}" class="text-blue-600 hover:text-blue-900 bg-blue-100 hover:bg-blue-200 p-2 rounded-full transition-colors duration-150" title="Edit">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <form action="{{ route('admin.accommodations.destroy', $accommodation) }}" method="POST" class="inline-block">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" onclick="return confirm('Are you sure you want to delete this accommodation?')" class="text-red-600 hover:text-red-900 bg-red-100 hover:bg-red-200 p-2 rounded-full transition-colors duration-150" title="Delete">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <tr>
                        <td colspan="5" class="px-5 py-8 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-gray-600 text-base mb-2">No accommodations found</p>
                                <p class="text-gray-500 mb-4">Try adjusting your search or filter criteria</p>
                                <a href="{{ route('admin.accommodations.create') }}" class="text-amber-600 hover:text-amber-800 bg-amber-50 hover:bg-amber-100 px-4 py-2 rounded-full transition-colors duration-150 flex items-center font-medium">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="px-5 py-3 border-t border-gray-200 bg-amber-50">
