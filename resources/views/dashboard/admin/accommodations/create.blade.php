...
<div class="container mx-auto px-4 py-6">
    <div class="bg-white shadow-md rounded-lg overflow-hidden border border-amber-200">
        <div class="bg-amber-500 text-white px-6 py-4 flex items-center">
            ...
            <h2 class="text-xl font-semibold">Create New Accommodation</h2>
        </div>

        <form action="{{ route('admin.accommodations.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="address" id="address" value="{{ old('address') }}" class="form-input rounded-md shadow-sm w-full @error('address') border-red-500 @enderror" required>
                        @error('address')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="price_range" id="price_range" class="form-select rounded-md shadow-sm w-full @error('price_range') border-red-500 @enderror" required>
                            ...
                            <option value="mid-range" {{ old('price_range') == 'mid-range' ? 'selected' : '' }}>Mid-Range</option>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="price_min" id="price_min" value="{{ old('price_min') }}" min="0" step="0.01" class="form-input pl-7 rounded-md shadow-sm w-full @error('price_min') border-red-500 @enderror" required>
                            </div>
                            @error('price_min')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="price_max" id="price_max" value="{{ old('price_max') }}" min="0" step="0.01" class="form-input pl-7 rounded-md shadow-sm w-full @error('price_max') border-red-500 @enderror" required>
                            </div>
                            @error('price_max')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea name="description" id="description" rows="5" class="form-textarea rounded-md shadow-sm w-full @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="form-input rounded-md shadow-sm w-full @error('phone') border-red-500 @enderror">
                        @error('phone')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}" class="form-input rounded-md shadow-sm w-full @error('email') border-red-500 @enderror">
                        @error('email')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" name="website" id="website" value="{{ old('website') }}" class="form-input rounded-md shadow-sm w-full @error('website') border-red-500 @enderror" placeholder="https://example.com">
                        @error('website')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
