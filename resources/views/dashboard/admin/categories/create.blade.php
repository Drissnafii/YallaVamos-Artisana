...
<div class="container mx-auto px-4 py-6 max-w-3xl">
    ...
    <div class="flex justify-between items-center mb-6">
        <div class="flex items-center">
            ...
            <h1 class="text-xl font-medium text-gray-800">Create New Category</h1>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden mb-8">
        <div class="border-b border-gray-200">
            <div class="px-6 py-4">
                <h2 class="text-lg font-medium text-gray-800">Category Information</h2>
                <p class="text-sm text-gray-500">Fill in the details to create a new category</p>
            </div>
        </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                        class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
