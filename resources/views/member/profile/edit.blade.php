...
@section('content')
    <div class="max-w-5xl mx-auto relative">
        <!-- Hero profile header - Material Design inspired with dark theme -->
        <div class="rounded-lg overflow-hidden mb-8 relative z-0">
            <div class="bg-gradient-to-r from-gray-800 to-gray-900 px-6 py-12 sm:px-10 relative">
                ...
                <label for="background_image"
                    class="absolute top-3 right-3 p-2 bg-black bg-opacity-50 rounded-full text-white cursor-pointer hover:bg-opacity-70 transition-all duration-200 z-10">
                    ...
                    <div class="grid grid-cols-1 gap-y-8">
                        ...
                        <div class="pt-4 border-t border-gray-100">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                                ...
                                <span class="text-xs text-gray-500 mt-1 sm:mt-0">Leave blank if you don't want to change
                                    it</span>
                            </div>
